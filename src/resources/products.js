export const  products = [{
    ...
    details: [{
        ...
        name: 'Цвет',
        value: 'Полуночный (Midnight black), Синий (Blue), Фиолетовый (Purple), Звездный (Starlight)'
    }, {
        name: 'Размер',
        value: '6,1 дюйма'
    }, {
    ...
    details: [{
        name: 'Процессор',
        value: 'Qualcomm Snapdragon 778G+'
    }, {
        name: 'Цвет',
        value: 'изумрудный зеленый'
    }, {
        name: 'Размер',
        value: '6,67 дюйма'
    }, {
    ...
    details: [{
        name: 'Процессор',
        value: 'Qualcomm Snapdragon 695 5G'
    }, {
        name: 'Цвет',
        value: 'Изумрудно-зеленый (Emerald Green), Полночный черный (Midnight Black), Титановый серебристый (Titanium Silver)'
    }, {
        name: 'Размер',
        value: '6,67 дюйма'
    }, {
    ...
    details: [{
        ...
        name: 'Цвет',
        value: 'Полночный черный (Midnight Black), Небесно-голубой (Cyan Lake), Титановый серебристый (Titanium Silver)'
    }, {
        name: 'Размер',
        value: '6,67 дюйма'
    }, {
